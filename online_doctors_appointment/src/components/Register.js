...
import genderList from "../config/GenderList";
...
const Register = () => {
  ...
  useEffect(()=> {
    setErrMsg('');
  }, [fullName, email, password, age, gender, mobile, address]);
  ...
  const ageOptions = ageList.map((age) => (
          ...
          <form className="reg-form">
            ...
            <div className="option-list">
              <div>
                ...
                <select id="age" value={age} onChange={onAgeChanged}>
                  <option value={""}></option>
                  {ageOptions}
                </select>
              </div>
